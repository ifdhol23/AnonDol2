...
helpMessage ="""馃懝 CommandMember 馃懣
馃懝 Creator = Melihat Pembuat Bot
馃懣 Dol say = Mengikuti Apa Yang DiKatakan
馃懝 Gcreator = Check Creator Grup

馃懝 Command Creator 馃懣

馃懣 Admin add @ = Menambahkan Admin
馃懝 Admin remove @ = Menghapus Admin
馃懣 Adminlist = Cek Admin
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Instagram ifdhol12")
						print "DiLike"
					except:
							pass
				else:
